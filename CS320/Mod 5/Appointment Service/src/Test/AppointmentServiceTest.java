...
class AppointmentServiceTest {
	...
	void testUpdateAppointmentDate() {
		...
		assertEquals(Date(3022, Calendar.FEBRUARY, 2), service.getAppointment("7").getAppointmentDate(),
	...
	void testUpdateAppointmentDesc() {
		...
		service.displayAppointmentList();
		assertEquals("Updated Description", service.getAppointment("9").getAppointmentDesc(),
	...
	void testDeleteAppointment() {
		...
		// Ensure that the AppointmentList is now empty by creating a new empty
		// AppointmentList to compare it with
