...
public class Appointment {
	 ...
	 * filled
	 * with the phrase "NULL" to protect data integrity as a placeholder.
	 * Appointment ID is truncated
	 * to a maximum of 10 characters, appointment date to 20 characters, and
