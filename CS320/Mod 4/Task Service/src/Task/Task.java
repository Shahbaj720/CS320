...
public class Task {
	 ...
	 * All parameters are checked if null or empty. If either exists, the field is
	 * filled
	 * with the phrase "NULL" to protect data integrity as a placeholder. Task ID is
	 * truncated
	 * to a maximum of 10 characters, task name to 20 characters, and description to
	 * 50 characters.
	 * 
	 */
	public Task(String taskName, String taskDesc) {
		...
		// TASKID
		// Task ID is generated when the constructor is called. It is set as a final
		// variable and has
